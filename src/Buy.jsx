...
const Buy = () => {
    return (
        <div className='bg-[#FBC42E] z-10 -mt-26 custom-text'>
            <div className='pt-36'>
                <img
                className='mx-auto mt-14 mb-9'
                src={buy} alt="" />
            </div>
            ...
            <div className="px-8 py-6 bg-white border rounded-lg shadow-md">
                ...
                <p className="mt-2 text-black  text-lg">Fill up your SOL wallet - you can't jump on the crypto bandwagon without fuel.</p>
            </div>
            <div className="px-8 py-6 bg-white border rounded-lg shadow-md">
